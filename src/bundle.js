    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('img', { src: 'public/img/error.jpg', alt: this.props.title, onLoad: this.handleImageload, onError: this.handleImageError })
        ),
        React.createElement(
          'div',
          { className: 'caption' },
...
React.createElement(ArticleBox, { url: '//beauties-lab317.rhcloud.com/articles?sort=url,desc' }), document.getElementById('content'));
